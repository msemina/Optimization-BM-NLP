...
! éèàëÄçàÖ èÖêÖåÖççõï
    ...
    LOGICAL, DIMENSION(2)::PAR0,PAR1 ! ÑãàçÄ çÖ ÇÖêçÄ (ÇÖêéüíçé N)
...
! èEóATú àCXOÑHõX ÑAHHõX
    IF(PODRP/=0)THEN
        WRITE(*,"(/A/)")    '     MàHàMàáAñàü METOÑOM HAàCKOPEâòEÉO CèìCKA: AP2'
        WRITE(*,"(A,I5)")   '     PAáMEPHOCTú èPOCTPAHCTBA èEPEMEHHõX  N= ',N
        WRITE(*,"(A,D12.5)")'     TOóHOCTú PEòEHàü áAÑAóà              E= ',E
        WRITE(*,"(A,I5)")   '     óàCãO àTEPAñàâ                       D= ',D
        WRITE(*,"(A,D12.5)")'     HAóAãúHõâ òAÉ CèìCKA                 C= ',C
        WRITE(*,"(A,D12.5)")'     MAÜOPAHTA APMàâO                     P1=',P1
        WRITE(*,"(A,D12.5)")'     KOùîîàñàEHT ìMEHúòEHàü òAÉA          P3=',P3
        WRITE(*,"(A,D12.5)")'     MAÜOPAHTA ÉOãÑCTEâHA                 P4=',P4
        WRITE(*,"(A,I5)")   '     HOMEP BEPCàà METOÑA                  V= ',L
        WRITE(*,"(A,D12.5)")'     HEOèPEÑEãEHHOCTú áAÑAHàü ÉPAHàñ      TG=',TG
...
END SUBROUTINE AP2
!-------------------------------------------------------------------------------------------------------------------------------
! BCèOMOÉATEãúHAü èOÑèPOÉPAMMA Ñãü AP2 ( PAHúòE ÅõãA S )
...
END SUBROUTINE SAP2
!-------------------------------------------------------------------------------------------------------------------------------
! BCèOMOÉATEãúHAü èOÑèPOÉPAMMA Ñãü AP2 ( PAHúòE ÅõãA F1 )
...
END FUNCTION F1AP2
!-------------------------------------------------------------------------------------------------------------------------------
! BCèOMOÉATEãúHAü èOÑèPOÉPAMMA Ñãü AP2 ( PAHúòE ÅõãA S1 )
...
!-------------------------------------------------------------------------------------------------------------------------------
! BCèOMOÉATEãúHAü èOÑèPOÉPAMMA Ñãü AP2 ( PAHúòE ÅõãA S2 )
