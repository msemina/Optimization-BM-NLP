...
!
    ...
    END DO
    IF(PODRP/=0)THEN
        WRITE(*,"(/A/)")    '     METOÑ BHEòHàX òTPAîHõX îìHKñàâ: CP4'
        ...
        WRITE(*,"(A,D12.5)")'     HAóAãúHõâ KOùîîàñàEHT òTPAîA    T=  ',T
        WRITE(*,"(A,D12.5)")'     KOùîîàñàEHT ìBEãàóEHàü òTPAîA   Z=  ',Z
    ...
    DO I=1,N
        IF(X(I)<A(I)-EW.OR.X(I)>B(I)+EW)THEN
            ...
            PAR(1+Q)=EBM
            IF(PODRP/=0)WRITE(*,"(/30X,'OèTàMAãúHAü TOóKA')")
