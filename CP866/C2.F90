...
! 
    ...
    IF(PODRP/=0)THEN
        ...
        WRITE(*,"(A,D12.5)")'     HAóAãúHõâ KOùîîàñàEHT òTPAîA    G=  ',G
        WRITE(*,"(A,D12.5)")'     èAPAMETP BCèOMOÉ. áAÑAóà        E1= ',E1
...
! HAóAãO OCHOBHOÉO ñàKãA
    DO
        ...
        DO
            ...
            IF(IN==0)THEN
                IF(NF<1.D-3)THEN
                    WRITE(*,"(20X,'TOóKA BHìTP;ÉPAÑ îìHK<MàH')")
            ...
            ELSE
                ...
                IF(FA>=0.999D+15)THEN
                    IF(E1>1.D-8)THEN
                        E1=E1/2
                    ELSE
                        WRITE(*,"(20X,'HET PEòEHàü áAÑAóà ãè')")
                        CALL PRTNLP(KK,N,L,M,X,YY,P,ST,CRIT,1,4,TEXT)
                        RETURN
                    END IF 
                END IF
