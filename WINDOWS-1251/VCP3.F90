! ÈCÏOËÜÇOBAHÈE METOÄOB ÈÇ ÏAKETA OÏTÈMÈÇAÖÈÈ METOÄ ÏÀÐÀÌÅÒÐÈÇÀÖÈÈ ÖÅËÅÂÎÉ ÔÓÍÊÖÈÈ (CP3)
...
! OÏÈCAHÈE ÏAPAMETPOB ÏPOÃPAMMÛ METOÄA
    ...
    ! PAÇMEPHOCTÜ MACCÈBOB YT,Y1,Y2,Y11 = M+1
...
! ÇAÄAHÈE ÏAPAMETPOB METOÄA
    ...
    PAR(5)=-5.          ! HÈÆHßß OÖEHKA ÇHA×EHÈß MÈHÈMÈÇÈPÓEMOÉ ÔÓHKÖÈÈ
    PAR(6)=0.5          ! KOÝÔÔÈÖÈEHT ÓMEHÜØEHÈß TO×HOCTÈ PEØEHÈß ÇAÄA×È ÁEÇÓCËOBHOÉ MÈHÈMÈÇAÖÈÈ (ÁEPETCß ÈÇ ÈHTEPBAËA [0,1])
