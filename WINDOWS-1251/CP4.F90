...
!
    ...
    END DO
    IF(PODRP/=0)THEN
        WRITE(*,"(/A/)")    '     METOƒ BHEÿH»X ÿTPA‘H€X ‘”HK÷»…: CP4'
        ...
        WRITE(*,"(A,D12.5)")'     HA◊AÀ‹H€… KO›‘‘»÷»EHT ÿTPA‘A    T=  ',T
        WRITE(*,"(A,D12.5)")'     KO›‘‘»÷»EHT ”BEÀ»◊EH»ﬂ ÿTPA‘A   Z=  ',Z
    ...
    DO I=1,N
        IF(X(I)<A(I)-EW.OR.X(I)>B(I)+EW)THEN
            ...
            PAR(1+Q)=EBM
            IF(PODRP/=0)WRITE(*,"(/30X,'OœT»MAÀ‹HAﬂ TO◊KA')")
