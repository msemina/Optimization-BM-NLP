C       M E T O Ä  H Ü Þ T O H A . B E P C È ß   2.                     
C                                                                       
...
C                                                                       
C          ÏE×ATÜ ÈCXOÄHÛX ÄAHHÛX                                       
C                                                                       
      PRINT 1100                                                        
 1100 FORMAT(/5X,'MÈHÈMÈÇAÖÈß METOÄOM HÜÞTOHA.BEPCÈß 2.')               
      PRINT 1101,N,E,D,ST,E1,H                                          
 1101 FORMAT(/5X,'PAÇMEPHOCTÜ ÏPOCTPAHCTBA ÏEPEMEHHÛX',2X,'N=',I3,      
     &       /5X,'TO×HOCTÜ PEØEHÈß ÇAÄA×È',14X,'E=',D11.4,              
     &       /5X,'×ÈCËO ÈTEPAÖÈÉ',23X,'D=',I5,                          
     &       /5X,'HA×AËÜHÛÉ ØAÃ CÏÓCKA',17X,'ST=',D11.4,                
     &       /5X,'MAÆOPAHTA ÃOËÄCTEÉHA',17X,'E1=',D11.4,                
     &       /5X,'ØAÃ ÄÈÔÔEPEHÖÈPOBAHÈß',17X,'H=',D11.4,/)              
    ...
    3 C4=C3                                                             
      ...
      IF(.NOT.(DABS(C3).LT.DABS(C0))) GO TO 52                          
          IF(GRAT) GO TO 53                                             
            ...
            GO TO 1                                                     
   53     PRINT 154                                                     
  154     FORMAT(10X,'OÄHOMEPHÛÉ ÏOÈCK HEÓÄA×EH')                       
          RETURN                                                        
   52 DO 230 I=N1,N2                                                    
          XV(I)=X(I)-C3*P1(I)                                           
  230 CONTINUE                                                          
    ...
    5       C2=C3*0.5D0                                                 
            IF(.NOT.(DABS(C2).LT.DABS(C0))) GO TO 54                    
                IF(GRAT) GO TO 55                                       
                   ...
                   GO TO 1                                              
   55           PRINT 155                                               
  155           FORMAT(10X,'OÄHOMEPHÛÉ ÏOÈCK HEÓÄA×EH')                 
                RETURN                                                  
   54      DO 240 I=N1,N2                                               
               XV(I)=X(I)-C2*P1(I)                                      
  240      CONTINUE                                                     
...
C                                                                       
   ...
   21 FORMAT(/,5X,'OÏTÈMAËÜHAß TO×KA')                                  
