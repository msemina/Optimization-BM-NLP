...
! 
    ...
    IF(PODRP/=0)THEN
        ...
        WRITE(*,"(A,D12.5)")'     HA×AËÜHÛÉ KOÝÔÔÈÖÈEHT ØTPAÔA    G=  ',G
        WRITE(*,"(A,D12.5)")'     ÏAPAMETP BCÏOMOÃ. ÇAÄA×È        E1= ',E1
...
! HA×AËO OCHOBHOÃO ÖÈKËA
    DO
        ...
        DO
            ...
            IF(IN==0)THEN
                IF(NF<1.D-3)THEN
                    WRITE(*,"(20X,'TO×KA BHÓTP;ÃPAÄ ÔÓHK<MÈH')")
            ...
            ELSE
                ...
                IF(FA>=0.999D+15)THEN
                    IF(E1>1.D-8)THEN
                        E1=E1/2
                    ELSE
                        WRITE(*,"(20X,'HET PEØEHÈß ÇAÄA×È ËÏ')")
                        CALL PRTNLP(KK,N,L,M,X,YY,P,ST,CRIT,1,4,TEXT)
                        RETURN
                    END IF 
                END IF
