...
! ÏÅ×ÀÒÜ ÈÑÕÎÄÍÛÕ ÄÀÍÍÛÕ
    IF(PODRP/=0)THEN
        WRITE(*,"(/A/)")    '     MÈHÈMÈÇAÖÈß METOÄOM COÏPßÆEHHÛX ÃPAÄÈEHTOB: AP3'
        WRITE(*,"(A,I5)")   '     HOMEP BEPCÈÈ METOÄA                     VAR=',VAR
        WRITE(*,"(A,I5)")   '     PAÇMEPHOCTÜ ÇAÄA×È                      N=  ',N
        WRITE(*,"(A,D12.5)")'     TO×HOCTÜ PEØEHÈß ÇAÄA×È                 E=  ',E
        WRITE(*,"(A,D12.5)")'     HA×AËÜHÛÉ ØAÃ CÏÓCKA                    C=',C
        WRITE(*,"(A,D12.5)")'     TO×HOCTÜ OÄHOMEPHOÉ MÈHÈMÈÇAÖÈÈ         E1= ',E1
        WRITE(*,"(A,D12.5)")'     MÈHÈMAËÜHÛÉ ØAÃ CÏÓCKA                  EV= ',EV
        WRITE(*,"(A,I5)")   '     BOCCTAHOBËEHÈE                          M=  ',M
        WRITE(*,"(A,I5)")   '     MAKCÈMAËÜHOE ×ÈCËO ÈTEPAÖÈÉ             D=  ',D
        WRITE(*,"(A,I5)")   '     ÏOPßÄOK ÄÈÔÔEPEHÖÈPOBAHÈß               AA= ',AA
