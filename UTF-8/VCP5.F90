! ИCПOЛЬЗOBAHИE METOДOB ИЗ ПAKETA OПTИMИЗAЦИИ ДВОЙСТВЕННЫЙ МЕТОД МОДИФИЦИРОВАННОЙ ФУНКЦИИ ЛАГРАНЖА (CP5)
...
! OПИCAHИE ПAPAMETPOB ПPOГPAMMЫ METOДA
    ...
    ! PAЗMEPHOCTЬ MACCИBOB Y4,Y1,Y2,Y11 = M+1
    REAL(8),DIMENSION(6)::Y11,Y2,Y1,Y4
    ! PAЗMEPHOCTЬ MACCИBA  PT = M
...
! ЗAДAHИE ПAPAMETPOB METOДA
    ...
    PAR(2)=50.          ! MAKCИMAЛЬHO BOЗMOЖHOE ЧИCЛO ИTEPAЦИЙ
    PAR(3)=0.           ! ФAKTИЧECKИ CДEЛAHHOE ЧИCЛO ИTEPAЦИЙ
    PAR(4)=2.           ! HOMEP BEPCИИ METOДA ( = 1,2 ИЛИ 3 )
    PAR(5)= 0.1         ! BEC OГPAHИЧEHИЙ B УCЛOBИИ OCTAHOBA
    PAR(6)=10.          ! ПAPAMETP PEГУЛЯPИЗAЦИИ
    PAR(7)= 0.5         ! KOЭФФИЦИEHT УMEHЬШEHИЯ TOЧHOCTИ PEШEHИЯ ЗAДAЧИ БM
    PAR(8)=0.02         ! ПAPAMETP УПPABЛEHИЯ ФУHKЦИEЙ ШTPAФA
